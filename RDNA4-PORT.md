...
(different weights, not benchmarked here). If pure single-stream speed is your entire workload, evaluate his stack. Complete `docker run` commands for both profiles are on the
