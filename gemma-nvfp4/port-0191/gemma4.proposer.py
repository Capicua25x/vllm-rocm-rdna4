...
class Gemma4Proposer(SpecDecodeBaseProposer):
    ...
    def _create_draft_vllm_config(self) -> VllmConfig:
        ...
        # The gemma4_assistant draft is dense bf16 (config quantization_config=null).
        # Do NOT inherit the target's quant_config (e.g. NVFP4 compressed-tensors):
        # otherwise the draft's Attention layers create q/k/v scale+zero_point params
        # the bf16 checkpoint lacks -> "weights were not initialized from checkpoint".
        # Mirrors DraftModelProposer._create_draft_vllm_config (draft_model.py).
        base = replace(base, quant_config=None)
