...
> **Start here → [RDNA4-PORT.md](RDNA4-PORT.md)** — what's ported, release notes (current: **rc10**, 2026-08-20),
...
> (max multi-user throughput). Docker image: `capicua25x/vllm-rocm-rdna4:0.26.1-rdna4-rc10` (= `:latest`).
